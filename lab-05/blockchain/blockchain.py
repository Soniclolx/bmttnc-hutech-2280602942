...
class Blockchain:
    ...
    def proof_of_work(self, previous_proof):  # Thêm self vào
        new_proof = 1
        check_proof = False
    ...
    def add_transaction(self, sender, receiver, amount):  # Thêm self vào
        self.current_transactions.append({'sender': sender, 'receiver': receiver, 'amount': amount})
        return self.get_previous_block().index + 1

    def is_chain_valid(self, chain):  # Thêm self vào
